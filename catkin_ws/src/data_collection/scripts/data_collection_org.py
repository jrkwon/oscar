...
class DataCollection():
    ...
    def alt_vel_cb(self, value):
        self.alt_x = value.orientation.x
        self.alt_y = value.orientation.y
        self.alt_thrust = value.thrust
...
def main():
    ...
    rospy.Subscriber('/mavros/setpoint_raw/attitude', AttitudeTarget, dc.alt_vel_cb)
