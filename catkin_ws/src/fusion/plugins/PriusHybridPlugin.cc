    ...
    : dataPtr(new PriusHybridPluginPrivate)
{
  ...
  ros::NodeHandle nh;
  this->dataPtr->controlSub = nh.subscribe("fusion", 10, &PriusHybridPlugin::OnPriusCommand, this);
...
void PriusHybridPlugin::OnPriusCommand(const fusion::Control::ConstPtr &msg)
{
