...
#ifndef PRIUSCUP_PLUGINS_FUSIONENERGIAPLUGIN_HH_
#define PRIUSCUP_PLUGINS_FUSIONENERGIAPLUGIN_HH_
...
namespace gazebo
{
  ...
  class FusionEnergiaPlugin : public ModelPlugin
  {
    /// \brief Constructor.
    public: FusionEnergiaPlugin();

    /// \brief Destructor.
    public: virtual ~FusionEnergiaPlugin();
    ...
    private: void OnPriusCommand(const fusion::Control::ConstPtr &msg);
    ...
    /// \brief Private data
    private: std::unique_ptr<FusionEnergiaPluginPrivate> dataPtr;
  };
}
#endif
