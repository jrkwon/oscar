...
if [ -z "$1" ]; then
    ...
    roslaunch fusion track.launch x:=7.58439 y:=-102.82 z:=0.11515 R:=0 P:=0 Y:=0
elif [ "$1" == "sonoma_raceway" ]; then
    echo "Starting with $1..." #### experimental
    roslaunch fusion track.launch world:=$1 x:=0 y:=0 z:=0.179517 R:=-0.001258 P:=-0.010927 Y:=2.4979
